...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen w-full bg-navy-dark flex justify-center">
      <div className="w-full max-w-md min-h-screen bg-gradient-to-b from-navy-dark via-navy to-navy-dark flex flex-col">
        <header className="sticky top-0 z-40 px-5 pt-5 pb-3 glass-bottom border-b border-gold/10">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-serif text-lg tracking-wide text-gold">Curadoria</h1>
            </div>
          ...
          <nav className="mt-4 -mx-5 px-5 overflow-x-auto no-scrollbar">
        ...
        <main className="flex-1 px-5 py-5 pb-8 animate-fade-up">
          <Outlet />
        </main>
      </div>
    </div>
